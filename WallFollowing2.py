...
class WallFollowing:
    def __init__(self,motors,distance_gen):
      ...
      self.controller = PIController(proportional_constant=0.4,integral_constant=0.005,derivative_constant=0.05)
    ...
    def handleNewData(self,r1,r2): 
      ...
      if(not self.previous_r1):
        ...
        y=((r1+r2)/2) - self.set_point #+ve if on left side of set point line
